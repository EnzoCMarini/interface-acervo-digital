            ...
            <Card title={`${Livro.titulo}`} className="shadow-lg animate-fade-in transition-all duration-300 w-full max-w-4xl p-4 sm:p-6 md:p-8 mx-auto font-bold text-xl">
                <div className="flex flex-col gap-2">
                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2">
                        <span className="text-gray-500 font-medium tracking-tight">International Standard Book Number (ISBN)</span>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-2">
                        ...
                        <div className="flex flex-col gap-4">
                            ...
                            <div className="flex flex-col gap-3 ml-1 border-l-2 border-blue-50 relative pl-4">
                                <div className="flex flex-col">
                                    ...
                                    <span className="text-gray-700 font-medium break-all">{Livro.autor}</span>
                                </div>
                                <div className="flex flex-col">
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <Tag
                                        value={Livro.status_livro_emprestado ? "Ativo" : "Inativo"}
                                        severity={Livro.status_livro_emprestado ? "success" : "danger"}
                        ...
                        {/* Seção de Informação de compra */}
                        <div className="flex flex-col gap-4">
                            <h3 className="text-lg font-semibold text-primary-700 flex items-center gap-2">
                                <i className="pi pi-map-marker text-orange-500"></i> Informação de compra
                            </h3>
                            <div className="flex flex-col gap-3 ml-1 border-l-2 border-orange-50 relative pl-4">
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <span className="text-gray-700 font-medium leading-relaxed">{Livro.quant_disponivel}</span>
                                </div>
                                <div className="flex flex-col">
                                    <span className="text-xs uppercase text-gray-400 font-bold tracking-wider">Valor Aquisição</span>
                                    <span className="text-gray-700 font-medium">
